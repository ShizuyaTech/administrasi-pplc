                ...
                <div>
                    ...
                    <select id="section_id" 
                        ...
                        @foreach($sections as $section)
                            <option value="{{ $section->id }}" {{ old('section_id', $employee->section_id) == $section->id ? 'selected' : '' }}>
                                {{ $section->name }}
                            </option>
                        @endforeach
                    </select>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div>
                    ...
                    <select id="shift" 
                        ...
                        <option value="Shift A" {{ old('shift', $employee->shift) == 'Shift A' ? 'selected' : '' }}>Shift A</option>
                        <option value="Shift B" {{ old('shift', $employee->shift) == 'Shift B' ? 'selected' : '' }}>Shift B</option>
                        <option value="Non Shift" {{ old('shift', $employee->shift) == 'Non Shift' ? 'selected' : '' }}>Non Shift</option>
                    </select>
