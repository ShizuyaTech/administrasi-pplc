        ...
        <form method="POST" action="{{ route('business-trips.update', $businessTrip) }}" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                ...
                <div>
                    ...
                    <input type="number" id="estimated_cost" name="estimated_cost" value="{{ old('estimated_cost', $businessTrip->estimated_cost) }}" min="0" step="1" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 @error('estimated_cost') border-red-500 @enderror">
            ...
            <div id="card-usage-section" class="mb-6 border border-indigo-200 rounded-lg p-6 bg-indigo-50" style="display: {{ $businessTrip->transport == 'Mobil Dinas' ? 'block' : 'none' }};">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <div>
                        ...
                        <input type="number" id="card_usage_amount" name="card_usage_amount" min="0" step="1" value="{{ old('card_usage_amount', $existingCardUsage ? $existingCardUsage->usage_amount : '') }}" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500">
