...
<?php $__env->startSection('page-title', 'Manajemen Permission'); ?>
...
<div class="space-y-6">
                ...
                <div class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
                    <div class="bg-gray-50 px-6 py-4 border-b border-gray-200">
                        <h3 class="text-lg font-semibold text-gray-900 flex items-center">
                            ...
                            <span class="ml-2 text-sm font-normal text-gray-500">(<?php echo e($permissions->count()); ?> permissions)</span>
                        </h3>
                    </div>
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600">
                                        <code class="px-2 py-1 bg-gray-100 rounded text-xs"><?php echo e($permission->slug); ?></code>
                                    </td>
    ...
    <?php else: ?>
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-12 text-center">
            ...
            <p class="mt-4 text-sm text-gray-500">Belum ada permissions yang terdaftar</p>
        </div>
    <?php endif; ?>
</div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Development\administrasi-app\resources\views/permissions/index.blade.php ENDPATH**/ ?>