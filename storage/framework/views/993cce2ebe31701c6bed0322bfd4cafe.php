...
<?php $__env->startSection('title', 'Master List Item Consumable'); ?>
<?php $__env->startSection('page-title', 'Master List Item Consumable'); ?>

<?php $__env->startSection('content'); ?>
<div class="mb-6 flex items-center justify-between">
    <div>
        <a href="<?php echo e(route('consumables.index')); ?>" class="inline-flex items-center text-indigo-600 hover:text-indigo-900">
    ...
    <a href="<?php echo e(route('consumables.create')); ?>" class="inline-flex items-center px-4 py-2 bg-indigo-600 hover:bg-indigo-700 text-white font-medium rounded-lg">
...
<div class="bg-white rounded-lg shadow-sm border border-gray-200 p-4 mb-6">
    <form method="GET" action="<?php echo e(route('consumables.master-items')); ?>" class="flex gap-4">
        <div class="flex-1">
            <label for="search" class="block text-sm font-medium text-gray-700 mb-1">Cari Nama Item</label>
            <input type="text" id="search" name="search" value="<?php echo e(request('search')); ?>" placeholder="Cari nama item..." class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500">
        </div>
        ...
        <div class="flex items-end">
            <a href="<?php echo e(route('consumables.master-items')); ?>" class="px-6 py-2 bg-gray-200 hover:bg-gray-300 text-gray-700 font-medium rounded-lg">
                Reset
            </a>
        </div>
        <?php endif; ?>
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        <div class="flex items-center">
            ...
            <div class="ml-4">
                ...
                <p class="text-2xl font-bold text-gray-900"><?php echo e($masterItems->total()); ?></p>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        <div class="flex items-center">
            ...
            <div class="ml-4">
                ...
                <p class="text-2xl font-bold text-gray-900"><?php echo e($masterItems->count()); ?></p>
            </div>
        </div>
    </div>
</div>
...
<div class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
    <div class="overflow-x-auto">
        <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                <?php $__empty_1 = true; $__currentLoopData = $masterItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr class="<?php echo e($item->total_stock <= $item->total_minimum_stock ? 'bg-red-50' : ''); ?> hover:bg-gray-50">
                        <td class="px-6 py-4">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-center text-sm">
                            <span class="font-bold <?php echo e($item->total_stock <= $item->total_minimum_stock ? 'text-red-700' : 'text-gray-900'); ?>">
                                <?php echo e(number_format($item->total_stock, 0, ',', '.')); ?>

                            </span>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap text-center text-sm text-gray-500">
                            <?php echo e(number_format($item->total_minimum_stock, 0, ',', '.')); ?>

                        </td>
                        <td class="px-6 py-4 whitespace-nowrap text-center">
                            <span class="px-3 py-1 text-xs rounded-full bg-blue-100 text-blue-800 font-medium">
                                <?php echo e($item->section_count); ?> Seksi
                            </span>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap text-center">
                            <?php if($item->total_stock <= $item->total_minimum_stock): ?>
                                <span class="px-2 py-1 text-xs rounded bg-red-100 text-red-800 font-medium">⚠️ Low Stock</span>
                            <?php elseif($item->total_stock <= $item->total_minimum_stock * 1.5): ?>
                ...
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                    <tr>
                        <td colspan="6" class="px-6 py-8 text-center text-gray-500">
                            <?php if(request('search')): ?>
                                <p class="text-lg font-medium mb-1">Tidak ada item yang cocok dengan pencarian "<?php echo e(request('search')); ?>"</p>
                                <a href="<?php echo e(route('consumables.master-items')); ?>" class="text-indigo-600 hover:text-indigo-900">Reset pencarian</a>
                            <?php else: ?>
    ...
    <?php if($masterItems->hasPages()): ?>
    <div class="px-6 py-4 border-t border-gray-200">
        <?php echo e($masterItems->links('pagination.custom')); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Development\administrasi-app\resources\views/consumables/master-items.blade.php ENDPATH**/ ?>