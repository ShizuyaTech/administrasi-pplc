...
<body class="bg-gray-50 min-h-screen flex items-center justify-center">
    <div class="text-center px-4">
        ...
        <p class="mt-8 text-sm text-gray-400">
            Login sebagai: <span class="font-medium text-gray-500"><?php echo e(auth()->user()->name); ?></span>
            <?php if(auth()->user()->role): ?>
                &bull; Role: <span class="font-medium text-gray-500"><?php echo e(auth()->user()->role->name); ?></span>
            <?php endif; ?>
        </p>
        <?php endif; ?>
    </div>
...
<?php /**PATH D:\Development\administrasi-app\resources\views/errors/403.blade.php ENDPATH**/ ?>