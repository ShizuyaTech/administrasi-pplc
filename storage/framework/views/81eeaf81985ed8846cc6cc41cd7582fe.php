...
<div class="space-y-6">
    ...
    <div class="flex justify-between items-center">
        <h2 class="text-lg font-semibold text-gray-800">Daftar Role (<?php echo e($roles->total()); ?>)</h2>
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr>
                        <td colspan="5" class="px-6 py-12 text-center text-gray-500">
                            ...
                            <p class="mt-4 text-sm">Belum ada role yang terdaftar</p>
                        </td>
                    </tr>
                    <?php endif; ?>
                </tbody>
        ...
        <div class="px-6 py-4 bg-gray-50 border-t border-gray-200">
            <?php echo e($roles->links('pagination.custom')); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Development\administrasi-app\resources\views/roles/index.blade.php ENDPATH**/ ?>