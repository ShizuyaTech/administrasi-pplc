...
<div class="space-y-6">
    ...
    <div class="flex justify-between items-center">
        ...
        <div class="flex space-x-3">
            ...
            <a href="<?php echo e(route('overtimes.import.form')); ?>" class="bg-green-600 hover:bg-green-700 text-white font-medium py-2 px-4 rounded-lg inline-flex items-center">
                <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
