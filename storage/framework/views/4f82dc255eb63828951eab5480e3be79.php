...
<aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full lg:translate-x-0'"
    ...
    <nav class="flex-1 overflow-y-auto py-4 px-3 scrollbar-hide">
        <div class="space-y-1">
            ...
            <div x-data="{ open: <?php echo e(request()->routeIs('users.*') || request()->routeIs('roles.*') || request()->routeIs('permissions.*') ? 'true' : 'false'); ?> }">
                <!-- Dropdown Trigger -->
                <button @click="open = !open" 
                        class="w-full flex items-center justify-between px-4 py-3 text-gray-700 rounded-lg hover:bg-indigo-50 hover:text-indigo-600 transition <?php echo e(request()->routeIs('users.*') || request()->routeIs('roles.*') || request()->routeIs('permissions.*') ? 'bg-indigo-50 text-indigo-600' : ''); ?>">
                    <div class="flex items-center space-x-3">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div x-show="open" 
                    ...
                    <a href="<?php echo e(route('permissions.index')); ?>" 
                       class="flex items-center space-x-3 px-4 py-2 text-sm text-gray-600 rounded-lg hover:bg-indigo-50 hover:text-indigo-600 transition <?php echo e(request()->routeIs('permissions.*') ? 'bg-indigo-50 text-indigo-600' : ''); ?>">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
