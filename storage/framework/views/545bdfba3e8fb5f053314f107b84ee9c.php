...
<?php $__env->startSection('title', 'Import Data Karyawan'); ?>
<?php $__env->startSection('page-title', 'Import Data Karyawan dari Excel'); ?>
...
<div class="max-w-2xl mx-auto space-y-6">
    ...
    <div>
        <a href="<?php echo e(route('employees.index')); ?>" class="inline-flex items-center text-sm text-gray-600 hover:text-gray-900">
    ...
    <div class="bg-blue-50 border border-blue-200 rounded-lg p-4 flex items-start space-x-3">
        ...
        <div class="flex-1">
            ...
            <a href="<?php echo e(route('employees.import.template')); ?>"
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        ...
        <form method="POST" action="<?php echo e(route('employees.import')); ?>" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            ...
            <div class="mb-5 overflow-x-auto">
                ...
                <table class="text-xs border border-gray-200 rounded w-full">
                    ...
                    <tbody class="divide-y divide-gray-100">
                        ...
                        <tr><td class="px-3 py-1.5 border-r border-gray-200 font-mono">C</td><td class="px-3 py-1.5 border-r border-gray-200">Seksi (nama sesuai sistem)</td><td class="px-3 py-1.5 <?php if(auth()->guard()->check()): ?><?php echo e(auth()->user()->canManageAllSections() ? 'text-green-700' : 'text-gray-500'); ?><?php endif; ?>"><?php echo e(auth()->user()->canManageAllSections() ? 'Ya' : 'Diabaikan'); ?></td></tr>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Development\administrasi-app\resources\views/employees/import.blade.php ENDPATH**/ ?>