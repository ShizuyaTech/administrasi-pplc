            ...
            <div>
                <span class="relative z-0 inline-flex shadow-sm rounded-md">
                    ...
                    <?php
                        ...
                        $windowSize = 5; // Jumlah halaman yang ditampilkan
                        $halfWindow = floor($windowSize / 2);
                        
                        // Calculate start and end of sliding window
                        $start = max(1, $current - $halfWindow);
                        $end = min($last, $current + $halfWindow);
                        
                        // Adjust if window is at edges
                    ...
                    <?php if($end < $last): ?>
                        <a href="<?php echo e($paginator->url($last)); ?>" class="relative inline-flex items-center px-4 py-2 -ml-px text-sm font-medium text-gray-700 bg-white border border-gray-300 leading-5 hover:text-gray-500 focus:z-10 focus:outline-none focus:ring ring-gray-300 focus:border-blue-300 active:bg-gray-100 active:text-gray-700 transition ease-in-out duration-150">
                            <?php echo e($last); ?>
...
<?php endif; ?>
<?php /**PATH D:\Development\administrasi-app\resources\views/pagination/custom.blade.php ENDPATH**/ ?>