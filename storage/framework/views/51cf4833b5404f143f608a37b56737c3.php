...
<div class="space-y-6">
    ...
    <div class="flex justify-between items-center">
        <h2 class="text-lg font-semibold text-gray-800">Daftar User (<?php echo e($users->total()); ?>)</h2>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">
                            <?php echo e($user->employee?->name ?? $user->name); ?>

                        </td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600">
                            <?php echo e($user->employee?->nrp ?? '-'); ?>

                        </td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600">
                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-800">
                                <?php echo e($user->employee?->section?->name ?? '-'); ?>

                            </span>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600">
                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium 
                                <?php if($user->employee?->role?->name === 'Super Admin'): ?> bg-purple-100 text-purple-800
                                <?php elseif($user->employee?->role?->name === 'Group Leader'): ?> bg-green-100 text-green-800
                                <?php elseif($user->employee?->role?->name === 'Foreman'): ?> bg-yellow-100 text-yellow-800
                                <?php else: ?> bg-gray-100 text-gray-800 <?php endif; ?>">
                                <?php echo e($user->employee?->role?->name ?? '-'); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Development\administrasi-app\resources\views/users/index.blade.php ENDPATH**/ ?>