...
<?php $__env->startSection('title', 'Manajemen Section'); ?>
<?php $__env->startSection('page-title', 'Manajemen Section'); ?>
...
<div class="space-y-6">
    ...
    <div class="flex justify-between items-center">
        <div>
            <h2 class="text-lg font-semibold text-gray-800">Daftar Section (<?php echo e($sections->count()); ?>)</h2>
            <p class="text-sm text-gray-600 mt-1">Kelola section dan penugasan ke Supervisor/Manager</p>
        </div>
        <div class="flex space-x-3">
            <a href="<?php echo e(route('sections.assignments')); ?>" 
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-center text-sm text-gray-600">
                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-800">
                                <?php echo e($section->users_count); ?> users
                            </span>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap text-center text-sm font-medium">
                            <div class="flex items-center justify-center space-x-2">
                                ...
                                <?php if($section->users_count == 0): ?>
                                <form action="<?php echo e(route('sections.destroy', $section)); ?>" 
                                      method="POST" 
                                      class="inline"
                    ...
                    <tr>
                        <td colspan="5" class="px-6 py-10 text-center text-gray-500">
                            ...
                            <a href="<?php echo e(route('sections.create')); ?>" class="text-indigo-600 hover:text-indigo-800 mt-2 inline-block">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Development\administrasi-app\resources\views/sections/index.blade.php ENDPATH**/ ?>