...
<?php $__env->startSection('title', 'Import Data Overtime'); ?>
<?php $__env->startSection('page-title', 'Import Data Overtime dari Excel'); ?>

<?php $__env->startSection('content'); ?>
<div class="max-w-2xl mx-auto space-y-6">

    <div>
        <a href="<?php echo e(route('overtimes.index')); ?>" class="inline-flex items-center text-sm text-gray-600 hover:text-gray-900">
    ...
    <div class="bg-blue-50 border border-blue-200 rounded-lg p-4 flex items-start space-x-3">
        ...
        <div class="flex-1">
            ...
            <a href="<?php echo e(route('overtimes.import.template')); ?>"
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        ...
        <form method="POST" action="<?php echo e(route('overtimes.import')); ?>" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Development\administrasi-app\resources\views/overtimes/import.blade.php ENDPATH**/ ?>